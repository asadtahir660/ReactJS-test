...
export function HeroSection() {
    return (<section className="relative isolate overflow-hidden bg-black pb-24 pt-28 text-white sm:pb-28 md:pb-32 md:pt-[200px]">
      ...
      <div className="mx-auto grid min-h-[680px] max-w-[1760px] place-items-center px-4 sm:min-h-[740px] md:min-h-[800px]">
        <div className="relative flex w-full flex-col items-center text-center">
          <div className="inline-block leading-none">
           ...
           <h1 className="relative select-none text-[86px] font-black uppercase leading-[0.82] text-[#e7db00] sm:text-[150px] md:text-[230px] lg:text-[330px] xl:text-[370px]" data-text="Energy">
          ...
          <img alt="Rocket Raspberry and Berry 5-hour ENERGY bottles" className="hero-bottle-group relative z-10 -mt-10 w-[min(750px,92vw)] object-contain sm:-mt-20 md:-mt-36 lg:-mt-[20%]" src={heroBottleGroup}/>
