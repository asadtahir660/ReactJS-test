...
import orangeCap from '../../../assets/landing/orange-cap.png';
      ...
      <div className="mx-auto max-w-[1740px] px-4">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-4xl text-lg leading-8 text-[#777] md:text-xl">
            Discover our premium selection of 5-hour ENERGY shots, crafted to deliver long-lasting energy and mental clarity.
          </p>
        </div>
        ...
        <div className="mt-[72px] grid items-center gap-12 lg:grid-cols-[1fr_minmax(420px,600px)_1fr]">
          <div className="grid gap-9">
            {product.facts.map((fact) => (
              <div className="grid grid-cols-[78px_1fr] items-center gap-5 md:grid-cols-[96px_1fr]" key={fact.title}>
                <img alt="" className="h-[72px] w-[72px] object-contain md:h-20 md:w-20" src={fact.icon} />
                <div>
                  <h3 className="energy-heading text-3xl font-black uppercase text-[#444] md:text-4xl">{fact.title}</h3>
          ...
          <div className="max-w-xl lg:pl-8">
            ...
            <h3 className="energy-heading mt-3 text-5xl font-black uppercase text-[#444] md:text-6xl">{product.title}</h3>
